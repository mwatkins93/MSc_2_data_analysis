...
doc_table <- read_excel("Watershed_table_v1.xlsx", sheet = 2)

ws_table <- read_excel("Watershed_table_v1.xlsx")

chem <- readRDS("glfc_chem_cleaned_v1.00.rds")
...
### 3.04 Generate a model selection table with the MuMin package ----
...
summary(model.avg(kitchen_sink_table)) # multimodel inference
