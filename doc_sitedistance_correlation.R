...
### 0.2 - Make a km distance column for easier graph interpretation
...
dist_corr %>% 
  ...
  labs(y = "Mean DOC correlation coefficient", x = "Euclidean distance (km)")
...
### triple check the correlation matrix performed the right result
