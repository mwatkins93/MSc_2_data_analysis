...
#### 3.04.1 - Mean DOC ----
mean_base_model <- lm(mean.doc ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = standard_doc_tbl)
...
sc1_base_model <- lm(doc.s1 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = standard_doc_tbl)
...
sc2_base_model <- lm(doc.s2 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = standard_doc_tbl)
...
sc3_base_model <- lm(doc.s3 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = doc_s3_sub)
...
sc4_base_model <- lm(doc.s4 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = doc_s4_sub)
...
sc5_base_model <- lm(doc.s5 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = doc_s5_sub)
...
sc6_base_model <- lm(doc.s6 ~ Group + tprod_for_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st, data = standard_doc_tbl)
...
mean_base_model_plot <- dwplot(base_model_avgs) %>%
  ...
  theme_bw() +
  labs(title = "Average multiple regression coefficients - total productive forest") +
