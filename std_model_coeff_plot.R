...
#### 3.04.1 - Mean DOC ----
mean_base_model <- lm(mean.doc ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = standard_doc_tbl)
...
sc1_base_model <- lm(doc.s1 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = standard_doc_tbl)
...
sc2_base_model <- lm(doc.s2 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = standard_doc_tbl)
...
sc3_base_model <- lm(doc.s3 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = doc_s3_sub)
...
sc4_base_model <- lm(doc.s4 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = doc_s4_sub)
...
sc5_base_model <- lm(doc.s5 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = doc_s5_sub)
...
sc6_base_model <- lm(doc.s6 ~ Group + conifer_st + drainage_st + elev_st + open_wat_st + wetland_st + slope_st + insect5_st + harv10_st, data = standard_doc_tbl)
...
mean_base_model_plot <- dwplot(base_model_avgs) %>%
  ...
  theme_bw() +
  labs(title = "Average multiple regression coefficients - 5-year Infestation + 10-year Harvest") +
...
# Look at the correlations between harvest and infestation 

standard_doc_tbl %>% 
  ggplot(aes(x = `5-year Insect Disturbance (%)`, y = `5-year Harvest Disturbance (%)`)) +
  geom_point()

cor(standard_doc_tbl$`5-year Insect Disturbance (%)`, standard_doc_tbl$`5-year Harvest Disturbance (%)`, method = "spearman")

# 20 year insect & 15-year harvest: -0.55
# 20 year insect & 10-year harvest: -0.49
# 20 year insect & 5-year harvest: -0.27
# 15 year insect & 10-year harvest: 0.38
# 15 year insect & 5-year harvest: 0.44
# 10 year insect & 10-year harvest: 0.38
# 10 year insect & 5-year harvest: 0.45
# 5 year insect & 10-year harvest: 0.23
# 5 year insect & 5-year harvest: 0.24
